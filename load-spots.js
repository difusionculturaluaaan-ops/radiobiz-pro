#!/usr/bin/env node
/**
 * Simple script to load spots from Google Drive and output them as JSON
 * Usage: node load-spots.js <folderId>
 */
...
async function loadSpots(folderId) {
  try {
...
if (!folderId) {
  console.error('Usage: node load-spots.js <folderId>');
  process.exit(1);
}
